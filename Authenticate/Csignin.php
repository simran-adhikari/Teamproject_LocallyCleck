...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepare SQL statement to check if email and password match in Customer table
// Prepare SQL statement to check if email, password, and ISVERIFIED='Y' match in Customer table
$sql = "SELECT * FROM Customer WHERE EMAIL = :email AND PASSWORD = :password AND ISVERIFIED = 'Y'";
